...
class YandexShareApi extends YscPortlet
{
    ...
    public function renderContent()
    {
        echo '<script type="text/javascript" src="//yandex.st/share/share.js" charset="utf-8"></script>
              <div class="yashare-auto-init" data-yashareImage="'.$this->image.'" data-yashareTitle="'.$this->title.'" data-yashareDescription="'.$this->full_text.'" data-yashareL10n="' . Yii::app()->language . '" data-yashareType="' . $this->type . '" data-yashareQuickServices="' . $this->services . '"></div>';
    }
}